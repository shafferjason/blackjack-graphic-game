...
export const CARD_SKINS: CardSkin[] = [
  ...
  // ── RARE ──
  {
    ...
    previewGradient: 'linear-gradient(135deg, #0a1628, #00e5ff)',
    previewAccent: '#00e5ff',
    faceCardPalette: {
      red: {
        skin: '#e0d4c8', skinShade: '#a898a0', skinHi: '#f0e8e0',
        hair: '#00c8e0', hairHi: '#40e8ff',
        clothing: '#0a1628', clothingMid: '#0d2137', clothingHi: '#1a3a60',
        gold: '#00e5ff', goldDk: '#0098b8', goldLt: '#80f0ff',
        jewel: '#ff006e', jewelHi: '#ff4da0',
        ink: '#061020', lip: '#ff6688', lipShadow: '#cc4466',
        cheekWarmth: '#c890a0', beard: '#006880',
      },
      black: {
        skin: '#d8d0c8', skinShade: '#a090a0', skinHi: '#e8e0d8',
        hair: '#00b0d0', hairHi: '#30d0f0',
        clothing: '#0a1628', clothingMid: '#0d2137', clothingHi: '#183050',
        gold: '#00e5ff', goldDk: '#0098b8', goldLt: '#80f0ff',
        jewel: '#ff006e', jewelHi: '#ff4da0',
        ink: '#061020', lip: '#e05878', lipShadow: '#b04060',
        cheekWarmth: '#c08898', beard: '#005870',
      },
    },
    environment: { felt: '#0a1628', feltDark: '#050c18', feltLight: '#0d2137', accent: '#00e5ff' },
    cardBackDesign: { bg1: '#0a1628', bg2: '#050c18', border: '#0098b8', borderInner: '#00b8d8', pattern: 'rgba(0,229,255,0.08)', patternAlt: 'rgba(0,229,255,0.04)', accent: '#00e5ff', accentLight: '#80f0ff', diamond: '#00b8d8', logoFill: '#00e5ff', logoStroke: '#0098b8', patternStyle: 'circuit', centerLogo: 'diamond' },
  ...
  },
  {
    id: 'royal-gold',
    name: 'Royal Gold',
    description: 'Mughal Empire at its peak — miniature painting in gold and jewels',
  ...
  },
  {
    ...
    description: 'Secret 1920s jazz club where something supernatural stirs',
  ...
  },
  {
    id: 'arctic-frost',
    name: 'Arctic Frost',
    description: 'Frozen court beneath the Northern Lights',
    flavorText: 'Cold hands, cold heart, cold cards.',
    price: 650,
    tier: 'rare',
    sortOrder: 13,
    faceFilter: 'hue-rotate(190deg) saturate(1.15) brightness(1.06)',
    backFilter: 'hue-rotate(190deg) saturate(1.3)',
    borderColor: '#81d4fa',
    glowColor: 'rgba(129, 212, 250, 0.35)',
    previewGradient: 'linear-gradient(135deg, #0d1e30, #a8e6cf, #ce93d8)',
    previewAccent: '#81d4fa',
    faceCardPalette: {
      red: {
        skin: '#e8e4e0', skinShade: '#b0b8c8', skinHi: '#f4f0f0',
        hair: '#c0d8e8', hairHi: '#d8e8f4',
        clothing: '#0d47a1', clothingMid: '#1868b8', clothingHi: '#2888d0',
        gold: '#a8e6cf', goldDk: '#60b898', goldLt: '#c8f0e0',
        jewel: '#ce93d8', jewelHi: '#e0b0e8',
      ...
      black: {
        ...
        gold: '#a8e6cf', goldDk: '#60b898', goldLt: '#c8f0e0',
        jewel: '#81d4fa', jewelHi: '#b3e5fc',
        ink: '#041820', lip: '#9880a0', lipShadow: '#786878',
        cheekWarmth: '#b0a0b0', beard: '#406888',
      },
    },
    environment: { felt: '#0d1e30', feltDark: '#061020', feltLight: '#103050', accent: '#81d4fa' },
    cardBackDesign: { bg1: '#0d1e30', bg2: '#061020', border: '#2080c0', borderInner: '#38a0e0', pattern: 'rgba(129,212,250,0.08)', patternAlt: 'rgba(168,230,207,0.04)', accent: '#81d4fa', accentLight: '#b3e5fc', diamond: '#a8e6cf', logoFill: '#81d4fa', logoStroke: '#1870a8', patternStyle: 'crosshatch', centerLogo: 'diamond' },
    cardMaterial: 'silk',
    celebrationStyle: 'cosmic',
  },
  {
    ...
    description: '1920s Monte Carlo casino — Art Deco glamour and cunning',
  ...
  },
  {
    id: 'velvet-noir',
    name: 'Velvet Noir',
    description: '1940s film noir — fedoras, shadows, and one red accent',
    ...
    faceCardPalette: {
      red: {
        ...
        gold: '#a09890', goldDk: '#787068', goldLt: '#c0b8b0',
  ...
  // ── EPIC ──
  {
    id: 'crimson-flame',
    name: 'Crimson Flame',
    description: "A dying star's last civilization — beautiful melancholy in ember and ash",
  ...
  },
  {
    id: 'sakura-bloom',
    name: 'Sakura Bloom',
    description: 'Feudal Japan through ukiyo-e woodblock — honor, beauty, impermanence',
  ...
  },
  {
    id: 'shadow-dynasty',
    name: 'Shadow Dynasty',
    description: 'Shadow puppet court backlit by amber candlelight',
    ...
    faceFilter: 'contrast(1.12) brightness(0.96)',
    backFilter: 'brightness(0.88) contrast(1.12)',
    borderColor: '#f59e0b',
    glowColor: 'rgba(245, 158, 11, 0.35)',
    previewGradient: 'linear-gradient(135deg, #0a0808, #f59e0b)',
    previewAccent: '#f59e0b',
    faceCardPalette: {
      red: {
        skin: '#d8ccc0', skinShade: '#a89888', skinHi: '#e4d8cc',
        hair: '#1a1410', hairHi: '#2a2018',
        clothing: '#1a1a1a', clothingMid: '#2a2820', clothingHi: '#3a3830',
        gold: '#f59e0b', goldDk: '#b87008', goldLt: '#fbbf24',
        jewel: '#c03030', jewelHi: '#e05050',
        ink: '#0a0808', lip: '#a86060', lipShadow: '#804848',
        cheekWarmth: '#b89088', beard: '#181410',
      },
      black: {
        skin: '#d0c4b8', skinShade: '#a09080', skinHi: '#dcd0c4',
        hair: '#101010', hairHi: '#201818',
        clothing: '#0e0e0e', clothingMid: '#181814', clothingHi: '#22201a',
        gold: '#d4880a', goldDk: '#a06008', goldLt: '#e8a818',
        jewel: '#f59e0b', jewelHi: '#fbbf24',
        ink: '#080808', lip: '#a05858', lipShadow: '#784040',
        cheekWarmth: '#a88880', beard: '#080808',
      },
    },
    environment: { felt: '#0c0a08', feltDark: '#060504', feltLight: '#18140e', accent: '#f59e0b' },
    cardBackDesign: { bg1: '#0c0a08', bg2: '#060504', border: '#3a3020', borderInner: '#4a4030', pattern: 'rgba(245,158,11,0.08)', patternAlt: 'rgba(245,158,11,0.04)', accent: '#f59e0b', accentLight: '#fbbf24', diamond: '#d4880a', logoFill: '#f59e0b', logoStroke: '#8a5c06', patternStyle: 'scales', centerLogo: 'eye' },
    cardMaterial: 'metallic',
    celebrationStyle: 'shadow',
  },
  {
    id: 'solar-pharaoh',
    name: 'Solar Pharaoh',
    description: 'Ancient Egypt — human power meets solar divinity',
  ...
  },
  {
    id: 'celestial',
    name: 'Celestial',
    description: 'Living constellations stepping out of the night sky',
    flavorText: 'Written in the stars, dealt by fate.',
    price: 1100,
    tier: 'epic',
    sortOrder: 24,
    faceFilter: 'saturate(1.2) brightness(1.06)',
    backFilter: 'saturate(1.25) brightness(1.05)',
    borderColor: '#818cf8',
    glowColor: 'rgba(129, 140, 248, 0.4)',
    previewGradient: 'linear-gradient(135deg, #0c0a2e, #818cf8, #ffd700)',
  ...
  },
  {
    id: 'blood-moon',
    name: 'Blood Moon',
    description: 'Cursed court frozen in time beneath the crimson moon',
  ...
  },
  {
    id: 'animal-kingdom',
    name: 'Animal Kingdom',
    description: 'Serpent court of venom and scale — cobra, boa, and viper reign supreme',
    flavorText: 'Bow before the serpent throne.',
    price: 2500,
    tier: 'legendary',
    sortOrder: 33,
    faceFilter: 'saturate(1.2) contrast(1.06)',
    backFilter: 'saturate(1.15) brightness(1.04)',
    borderColor: '#d97706',
    glowColor: 'rgba(217, 119, 6, 0.4)',
    previewGradient: 'linear-gradient(135deg, #1a1408, #d97706)',
    previewAccent: '#d97706',
    faceCardPalette: {
      red: {
        skin: '#e8d0a8', skinShade: '#c09860', skinHi: '#f0dcc0',
        hair: '#5a3010', hairHi: '#7a4820',
        clothing: '#a06010', clothingMid: '#c07818', clothingHi: '#d89028',
        gold: '#e8b030', goldDk: '#a07010', goldLt: '#f0c850',
        jewel: '#d05020', jewelHi: '#e87040',
        ink: '#2a1808', lip: '#c07050', lipShadow: '#985838',
        cheekWarmth: '#d89868', beard: '#3a2010',
      },
      black: {
        skin: '#e0c8a0', skinShade: '#b89058', skinHi: '#e8d4b0',
        hair: '#281808', hairHi: '#3a2810',
        clothing: '#1a1408', clothingMid: '#2a2010', clothingHi: '#3a2c18',
        gold: '#d8a828', goldDk: '#906810', goldLt: '#e8c040',
        jewel: '#b84018', jewelHi: '#d06030',
        ink: '#141008', lip: '#b06848', lipShadow: '#885030',
        cheekWarmth: '#c88858', beard: '#181008',
      },
    },
    environment: { felt: '#1c1206', feltDark: '#100a02', feltLight: '#2e1c0c', accent: '#d97706' },
    cardBackDesign: { bg1: '#1a1408', bg2: '#0e0a04', border: '#a07010', borderInner: '#c08820', pattern: 'rgba(217,119,6,0.1)', patternAlt: 'rgba(217,119,6,0.05)', accent: '#d97706', accentLight: '#f59e0b', diamond: '#b88018', logoFill: '#d97706', logoStroke: '#7c4d0a', patternStyle: 'scales', centerLogo: 'spade' },
    cardMaterial: 'vellum',
    celebrationStyle: 'gold',
  },
  // ── LEGENDARY ──
  {
    id: 'gilded-serpent',
    name: 'Gilded Serpent',
    description: 'Mythic court of the serpent king — scales of gold and jade venom',
    ...
    faceFilter: 'saturate(1.35) contrast(1.08)',
    backFilter: 'saturate(1.3) brightness(1.05)',
    borderColor: '#d4a017',
    glowColor: 'rgba(212, 160, 23, 0.45)',
    previewGradient: 'linear-gradient(135deg, #0a1208, #d4a017)',
    previewAccent: '#d4a017',
    faceCardPalette: {
      red: {
        skin: '#d8d0b8', skinShade: '#a89868', skinHi: '#e8e0c8',
        hair: '#1a2008', hairHi: '#2a3018',
        clothing: '#046a38', clothingMid: '#08884a', clothingHi: '#10a860',
        gold: '#d4a017', goldDk: '#8b6914', goldLt: '#e8c040',
        jewel: '#b71c1c', jewelHi: '#d84040',
        ink: '#0a1808', lip: '#b89058', lipShadow: '#987040',
        cheekWarmth: '#c8a870', beard: '#1a1808',
      },
      black: {
        skin: '#d0c8b0', skinShade: '#a09060', skinHi: '#e0d8c0',
        hair: '#0e1408', hairHi: '#1a2010',
        clothing: '#1a1a0a', clothingMid: '#2a2810', clothingHi: '#3a3618',
        gold: '#c8980a', goldDk: '#8b6914', goldLt: '#e0b830',
        jewel: '#046a38', jewelHi: '#08884a',
        ink: '#0a0a08', lip: '#a88850', lipShadow: '#886838',
        cheekWarmth: '#c0a068', beard: '#0a0e08',
      },
    },
    environment: { felt: '#0a1408', feltDark: '#040a04', feltLight: '#142410', accent: '#d4a017' },
    cardBackDesign: { bg1: '#0a1408', bg2: '#040a04', border: '#8b6914', borderInner: '#a88018', pattern: 'rgba(212,160,23,0.1)', patternAlt: 'rgba(212,160,23,0.05)', accent: '#d4a017', accentLight: '#e8c040', diamond: '#046a38', logoFill: '#d4a017', logoStroke: '#6b5010', patternStyle: 'scales', centerLogo: 'serpent' },
    cardMaterial: 'metallic',
    celebrationStyle: 'emerald',
  },
  {
    id: 'dragons-hoard',
    name: "Dragon's Hoard",
    description: 'Dragon-bonded warriors — rider, mother, and king become one with fire',
    ...
    faceFilter: 'saturate(1.4) brightness(1.04) contrast(1.08)',
    backFilter: 'saturate(1.35) brightness(1.05)',
    borderColor: '#f59e0b',
    glowColor: 'rgba(245, 158, 11, 0.5)',
    previewGradient: 'linear-gradient(135deg, #1a0e04, #e65100, #f59e0b)',
    previewAccent: '#f59e0b',
    faceCardPalette: {
      red: {
  ...
  },
  {
    ...
    description: 'Prismatic civilization that compresses time into crystal',
    ...
    faceFilter: 'saturate(1.45) brightness(1.08) contrast(1.06)',
    backFilter: 'saturate(1.35) brightness(1.1)',
    borderColor: '#e0e7ff',
    glowColor: 'rgba(224, 231, 255, 0.55)',
    previewGradient: 'linear-gradient(135deg, #0a0a1e, #c7d2fe, #e0e7ff, #fbbf24)',
